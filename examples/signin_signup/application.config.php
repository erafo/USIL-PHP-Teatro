<?php 
	...
	$path = "http://localhost/final/USIL-PHP-Teatro/hybridauth/";
	$hybridauth_config = 'http://localhost/final/USIL-PHP-Teatro/hybridauth/config.php';

//	require_once( "http://localhost/final/USIL-PHP-Teatro/hybridauth/Hybrid/auth.php" );
